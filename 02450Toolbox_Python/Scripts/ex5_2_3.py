...
# If you have increase Km so that Km > Kd, you will start to see that the 
# regression deviates from the generator, the model is too flexible and will 
# tend to overfit the data, i.e. to capture patterns that are specific 
# to some points.
...
print("Score = ",model.score(Xm,y))
# print("Estimated parameters:")
# print("\tw0 = {:.5}\n\tw1 = {:.5}".format(model.intercept_, model.coef_))
