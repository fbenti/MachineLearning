...
# The last graph shows the residuals according to some of the transformations. 
# As a general rule, you want these residual plots to be symmetrically 
# distributed around 0 and without any clear pattern (a pattern is e.g. always 
# high residuals for low values and low residuals for high values).
